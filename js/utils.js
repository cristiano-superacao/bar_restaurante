...
(function(){
  ...
  if (typeof window !== 'undefined') {
    window.UTILS = { setText, getSelectedCompanyId, formatCurrency, formatDate, formatDateTime, debounce, throttle, storage, toast, currencyInputMask, CONSTANTS, populateSelect };
