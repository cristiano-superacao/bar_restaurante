...
PORT=3000
CORS_ORIGIN=https://barestaurante.netlify.app
```
...
- Headers endurecidos com Helmet
- CORS configurável via `CORS_ORIGIN` (padrão: qualquer origem)
- Rate limiting global e mais restrito para `POST /api/auth/login`
